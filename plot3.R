...
png("plot3.png")
with(reqdata, plot(datetime, sub1, type = "l", xlab = "", ylab = "Energy sub metering"))
with(reqdata, { lines(datetime,sub2, type = "l", col = "red")
        lines(datetime,sub3, type = "l", col = "blue")
})
legend("topright",col = c("black","red","blue"),lty = 1, 
       lwd = 2.5, legend = c("Sub_meteting_1","Sub_metering_2","Sub_metering_3"))
dev.off()